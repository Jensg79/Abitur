...
\end{enumerate}
\end{merke}
\section{Allgemeine Betrachtung Trigonometrischer Funktionen} \index{Funktionen!Trigonometrische! allgemeine Betrachtungen}
Die trigonometrischen Funktionen ergeben sich aus Betrachtungen am Einheitskreis mit darin einbeschriebenen rechtwinkligen Dreiecken. 
  ...
  \draw[xshift=1.85cm] node [right,text width=6cm,style=information text]
    {
      ...
      \]
      Durch den Satz des Pythagoras erhählt man ${\color{coscolor}\cos^2 \alpha} +
