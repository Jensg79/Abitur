...
\begin{itemize}
    ...
    Dies Darstellung gilt nur, \textcolor{red}{wenn alle} Nullstellen reelle Zahlen sind. Der Vorfaktor $a$ muss ist dann noch durch einen Punkt, der keine Nullstelle ist, extra bestimmt werden.
...
\end{tikzpicture}
    ...
    \begin{axis}[xmin= -2.1, xmax = 4.1, ymin= -0.5, ymax= 3.1,
        ...
        xlabel = $x$,
        ylabel=$y$]
        \addplot[line width=1pt,mark=none, color=red, restrict x to domain=2:3]  plot[samples=300,smooth]{x^2-2*x}; 
   \addplot[line width=1pt,mark=none, color=red, restrict x to domain=-2:0]  plot[samples=300,smooth]{x^2-2*x};
    \addplot[line width=1pt,mark=none, color=red, restrict x to domain=0:2]  plot[samples=300,smooth]{-1*x^2+2*x};
...
\end{tikzpicture}
    ...
    \begin{axis}[xmin= -3.6, xmax = 3.6, ymin= -1.3, ymax= 3.1,
        ...
        xlabel = $x$,
        ylabel=$y$]
        \addplot[line width=1pt,mark=none, color=red, restrict x to domain=0:3]  plot[samples=300,smooth]{x^2-2*x}; 
   \addplot[line width=1pt,mark=none, color=red, restrict x to domain=-3:0]  plot[samples=300,smooth]{(-1*x)^2+2*x};
...
\end{tikzpicture}
    ...
    \addplot[line width=1pt,mark=none, color=red, restrict x to domain=0:2]  plot[samples=300,smooth]{-1*x^2+2*x};
     \addplot[line width=1pt,mark=none, color=red, restrict x to domain=2:3]  plot[samples=300,smooth]{x^2-2*x}; 
    \addplot[line width=1pt,mark=none, color=red, restrict x to domain=-2:0]  plot[samples=300,smooth]{-1*x^2-2*x};
     \addplot[line width=1pt,mark=none, color=red, restrict x to domain=-3:-2]  plot[samples=300,smooth]{x^2+2*x}; 
