...
Die folgende tabellarische Übersicht zeigt die möglichen \textcolor{blue}{\textbf{gegenseitigen Lagebeziehungen zweier Geraden g und h}} mit den Richtungsvektoren \textcolor{blue}{\(\vv{u}\) bzw. \(\vv{v}\).}\\
\begin{center}
...
\end{b8d}
\section{Anwendungen}
\subsection{Schnittfläche Kugel Ebene}
\begin{merke}{}{}
...
\end{itemize}
\end{merke}
\subsection*{Mittelpunkt des Schnittkreises}
...
Gegeben ist die Kugel \(k\) mit dem Mittelpunkt \(M(1|2|3)\) und dem Radius \(R=5\) und die Ebene \(E:2x_1-2x_2+x_3+8=0\). 
    \begin{enumerate}
        ...
        \end{itemize}
    \end{enumerate}
    Mit der Angabe des Radius \(r\) des Mittelpunktes \(F\) des Kreises \(k\) ist der Kreis ausreichend bestimmt. 
\end{rechnung}