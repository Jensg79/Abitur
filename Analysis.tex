...
\begin{enumerate}
    ...
    \begin{equation*}
        ...
        \end{split}
    \end{equation*}
    Damit ist die Funktion $f(x)$ weder achsensymmetriach zu y-Achse noch punktsymmetrisch zum Ursprung.
    \item Nullstellen
    \begin{equation*}
        \begin{split}
            f(x) &= 0\\
            ...
            1 &= \sin{(2(x-\frac{\pi}{3}))} \hspace{0.5cm} | \arcsin{ ()} \hspace{0.2cm} \text{siehe hierfür \ref{EigenschaftSinCos}}\\ 
