...
Allgemeine Betrachtungen zum Sinus und Kosinus findet man im Anhang \ref{SinCos}. 
 ...
 \begin{defi}{Ableitungen von Sinus und Kosinus}{}
...
\begin{satz}{Ableitung des Tangens}{} \index{Ableitungsregln!Tangensfunktion}
...
\end{enumerate}
    \end{bsp}
 \subsection{Exponentialfunktionen}\index{e-Funktion}
...
\begin{tikzpicture}
    ...
    \draw[blue] (2,-1.2)   node [above] {$f(x) = e^x$};
    \end{axis}
\end{tikzpicture}
\end{center}
\begin{satz}{Ableitung der $e$-Funktion}{}\index{e-Funktion!Ableitung}
...
\end{satz}
 \subsubsection{Kurvendiskussion einer e-Funktion}\index{Kurvendiskussion!Exponentialfunktionen}
