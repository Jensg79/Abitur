...
\end{center}
 ...
 \begin{merke}{Halbkreise mit beliebigen Mittelpunkt}{}
   ...
   \begin{tikzpicture}
    \begin{axis}[xmin= -1.5, xmax = 5.5, ymin= -1.1, ymax=5.5,
    x=1cm,y=1cm,
        axis lines = middle, 
        ymajorgrids=true,
        xmajorgrids=true,
        ...
        ylabel=$y$,
        ticklabel style={font=\small,fill=green!5},]      
         \addplot[smooth,samples= 1000,domain=-0.9999999695999992:4.9999999531379]{(3^2-(x-2)^2)^(0.5) +2};
        \draw (2,1)   node [above] {$f(x)= 2+\sqrt{9-(x-2)^2}$};
        \draw (2,2) -- ++(-2.5pt,-2.5pt) -- ++(5pt,5pt) ++(-5pt,0pt) -- ++(5pt,-5pt);
        \draw (2.1,2.1)   node [above] {$M(2|2)$};
    \end{axis}
\end{tikzpicture}
\end{center}
 \end{merke}
