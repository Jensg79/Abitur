...
\end{center}
     ...
     \item Gegeben ist die Funktion h mit $h(x) = \dfrac{1}{x+2}$ mit $\mathds{D}_h = \mathds{R}\setminus\{-2\}$. Bei dieser Funktion kann die Definitionslücke nicht behoben werden. Um zu entscheiden, ob eine Polstelle mit oder ohne VZW vorliegt, muss eine Grenzwertbetrachtung an der Definintionslücke durchgeführt werden.
     \begin{equation*}
    \begin{split}
...
Um das Verhalten einer gebrochenrationalen Funktion $f$ für $x \longrightarrow \pm \infty$ zu untersuchen, dividiert man in der Bruchform Zähler und Nenner durch die höchste Potenz
des Nennerpolynoms.\\
...
\index{Ableitung!Hauptsatz Differential- und Integralfunktion}
    Die Funktion $f$ seim in Intervall $I=[r;s]$ stetig. Für die Integralfunktion $I_a : x \mapsto \integral[limits-mode=limits,
            limits={a, \textcolor{red}{x}},
...
\begin{defi}{Flächeminhalt}{}\index{Integral!Flächenberechnung}
    bei der Berechnung des \textbf{Inhalts der Fläche zwischen dem Graphen einer Funktion $f$ und der x-Achse} in einem Interval $I=[a,b]$ geht man wie folgt vor:
    \begin{enumerate}
