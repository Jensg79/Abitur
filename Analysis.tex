...
\begin{groupplot}[
  ...
  xmin=0, xmax=3.5, ymin=0, ymax=11.5,
  axis lines=left,
  xlabel={$x$}, ylabel={$y$},
...
\nextgroupplot
    ...
    \addplot[very thick, domain=0:3.15, samples=200] {\x^2};
\nextgroupplot
%%%%%%% Untersumme n=6
        \addlegendentry{$f(x)=x^2$}
...
\nextgroupplot
    ...
    \addplot[thick, domain=0:3.15, samples=200] {\x^2+1};
...
\begin{bsp}{für die Anwendung der Regeln}{}
    ...
    \begin{multicols}{3}
    \begin{description}
        \item[] $\integral{\dfrac{2}{x^2}}$
        \item[] $\integral{\dfrac{1}{\sqrt{x}}}$
        \item[] $\integral{\dfrac{1}{x}}$
    \end{description}   
    \end{multicols}
    $\integral{\dfrac{2}{x^2}} = 2\integral{x^{-2}} = 2 \cdot (-1) \cdot x^{-1} +c = -2\cdot \dfrac{1}{x} +c = \dfrac{-2}{x} +c$\\[0.2cm] $\integral{\dfrac{1}{\sqrt{x}}} = \integral{x^{-0,5}} = 2\cdot x^{0,5} + c = 2\cdot \sqrt{x} + c$ \\[0.2cm] $\integral{\dfrac{1}{x}} = \ln{|x|} + c$  \end{bsp}
...
Ein Rotationskörper entsteht, wenn die vom Graphen einer Funktion $f$ über dem Intervall $I=[a;b]$ eingeschlossenen Fläche um die $x-$Achse rotiert. \\
\begin{center}
