...
stetig, viele Einflüsse (Genetik, Ernährung, Zufall), oft recht symmetrisch \(\Rightarrow\) Normal \textit{plausibel}.
\item \textbf{Messfehler bei einem Experiment:} \\
„wahrer Wert + viele kleine Störungen“ \(\Rightarrow\) Normal \textit{sehr typisch}.
...
oft \textbf{rechtsschief} (klein geht, aber nach oben langer Schwanz) \(\Rightarrow\) Normal meist unpassend.
\item \textbf{Einkommen:} \\
stark rechtsschief, viele Ausreißer \(\Rightarrow\) Normal \textbf{unrealistisch}.
\end{enumerate}
