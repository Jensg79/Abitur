...
\end{enumerate}
\end{itemize}
\section{Stetige Zufallsgrößen}\index{Zufallsgrößen!Stetige}
...
\begin{axis}[
    ...
    title={5 Klassen: Balkenhöhe = Anteil im Intervall},
    nodes near coords,
...
\begin{axis}[
    ...
    xlabel={$x$ (cm)},
    ylabel={relative Häufigkeit},
    title={10 Klassen: feinere Auflösung, gleiche Tendenz},
]
% Mitten: 5,15,...,95
\addplot coordinates {
...
\begin{axis}[
    ...
    xlabel={$x$ (cm)},
    ylabel={relative Häufigkeit},
    title={20 Klassen: noch feiner, Form wird „kurviger“},
]
% Mitten: 2.5,7.5,...,97.5
\addplot coordinates {
...
\end{defi}
\begin{defi}{Dichtefunktion}{}\index{Zufallsgrößen!Stetige!Dichtefunktion}
...
\nextgroupplot
  ...
  \node[green!40!black] at (axis cs:{\xLabelAll+0.25},\yLabelAll)
    {$\displaystyle \int_{-\infty}^{+\infty} f(x)\,dx = 1$};

  \node[blue, font=\large] at (axis cs:2.18,0.06) {$G_f$};
...
\nextgroupplot
  ...
  \node[green!40!black] at (axis cs:\xmid,{\yProb-0.1})
    {$\mathrm{P}(r\le X \le s)$};
  \node[green!40!black, font=\small] at (axis cs:\xmid,\yInt)
...
y tick label style={
  ...
  /pgf/number format/precision=3
    ...
    xlabel={$x$ (cm)},
    ylabel={Dichte $f(x)$ (pro cm)},
    title={Dichtefunktion: Höhe „pro cm“, Fläche = Wahrscheinlichkeit},
]
