...
Jeder Wert $x$ einer Zufallsgröße $X$ tritt mit einer bestimmten Wahrscheinlichkeit $P(X=x)$ auf. Die Funktion, die jedem Wert $x$ einer ZG $X$ die Wahrscheinlichkeit $P(X=x)$ zuordnet, heißt \textcolor{red}{Wahrscheinlichkeitsverteilung} der Zufallsgröße $X$.\\
...
Eine Zufallsgröße nimmt die Werte $x_1, x_2,\ldots , x_n$ mit den Wahrscheinlichkeiten $P(X=x_1), P(X=x_2), \ldots, P(X=x_n)$ an.\\  Dann heißt der zu erwartende Mittelwert \[\mu =E(X) = \sum\limits_{i=1}^n x_i\cdot P(X=x_i)= x_1\cdot P(X=x_1) + x_2\cdot P(X=x_2) +\ldots + x_n \cdot P(X=x_n)\]
    \textcolor{red}{Erwartungswert} von $X$. 
    \end{defi}
    \begin{bem}{Eigenschaften des Erwartungswertes}{}
        \begin{itemize}
            \item Der Erwartungswert $\mu$ ist häufig \textcolor{red}{kein} Wert, den die Zufallsgröße annimmt.
  ...
  Eine Zufallsgröße mit $E(X) = \mu$ nehme die Werte $x_1, x_2,\ldots , x_n$ mit den Wahrscheinlichkeiten $P(X=x_1), P(X=x_2), \ldots, P(X=x_n)$ an. \\ 
  Dann heißt die mittlere quadratische Abweichung von $\mu$ \textcolor{red}{Varianz} von $X$: \[Var(X) = \sum\limits_{i=1}^n \left(x_i - \mu\right)^2 \cdot P(X = x_i)= \left(x_1 - \mu\right)^2 \cdot P(X = x_1) + \ldots + \left(x_n - \mu\right)^2 \cdot P(X = x_n)\]
    ...
    \begin{bem}{Eigenschaften der Varianz}{}\index{Zufallsgröße!Varianz!Eigenschaften}
       Die Werte einer Zufallsgröße sind häufig Maßzahlen einer Größe. Folglich ist die Varianz von \(X\) die Maßzahl einer Größe, die im Quadrat gemessen wird. Da dies in der Praxis nicht sehr anschaulich ist, wird mit der Standardabweichung ein neues Maß eingeführt.  
    \end{bem}
    \begin{defi}{Die Standardabweichung}{}\index{Zufallsgröße!Standardabweichung}
Die Standardabweichung $\sigma$ einer Zufallsgröße $X$ bestimmt sich durch $\sigma = \sqrt{Var(X)}$
    \end{defi}
...
die \emph{hypergeometrische Wahrscheinlichkeit}, wobei die Zufallsgröße \(X\) die Anzahl der gezogenen Erfolgskugeln ist.
\end{defi}
...
\begin{satz}{Mindestens 1 Treffer}{}\index{Binomialverteilung!Mindestens ein Treffer}
    Die Wahrscheinlichkeit mindestens ein Treffer bei einer binomialverteilten Zufallsgröße \(B(n,p)\) lässt sich mit der Gegenwahrscheinlichkeit kein Treffer sehr leicht berechnen. \[P_p^n(X\geq 1) = 1- P_p^n(X=0) = 1-q^n = 1- \left(1-p\right)^n\]
\end{satz}
...
Werden aus einer großen Gesamtheit nur wenige Elemente ausgewählt, darf man die interessierenden Wahrscheinlichkeiten näherungsweise mit der Bernoulli'schen Formel berechnen.
   ...
   Ist eine Zufallsgröße \(X\) nach \(B(n,p)\) verteilt, so ist die Trefferanzahl \(k\) mit der größten Wahrscheinlichkeit entweder \begin{itemize}
   ...
   \end{itemize}
    \end{merke}
    Im folgenden sollen einige Eigenschaften von Histogrammen \index{Zufallsgröße!Binomialverteilung!Histogramme}betrachtet werden.
...
\begin{axis}[
  ...
  bar width=9.5pt,
  enlarge x limits=0,
  xlabel={},           % x-Beschriftung aus
  ylabel={},           % y-Beschriftung aus
  xmin=0, xmax=43.5,          % <- bis 43 abgeschnitten (mit Rand)
  ymin=0, ymax=0.26,
  axis lines=left,
...
\begin{axis}[
  ...
  xlabel={},           % x-Beschriftung aus
  ylabel={},           % y-Beschriftung aus
  xmin=0, xmax=36.5,          % <- bis 36 abgeschnitten (mit Rand)
  ymin=0, ymax=0.26,
  axis lines=left,
  axis line style={->, line width=0.9pt},
  tick align=outside,
...
(0,3.777893186295e-03) (1,2.361183241434e-02) (2,7.083549724302e-02)
(3,1.353132491640e-01) (4,1.827829863714e-01) (5,1.960151025272e-01)
(6,1.666128371482e-01) (7,1.144296494291e-01) (8,6.555951494659e-02)
(9,3.182279512562e-02) (10,1.323281580224e-02) (11,4.771338282880e-03)
(12,1.491043213400e-03) (13,4.065581400002e-04) (14,9.680908095241e-05)
(15,2.016856036527e-05) (16,3.682515427899e-06) (17,5.892024684638e-07)
(18,8.188923173108e-08) (19,9.941744420951e-09) (20,1.043383264199e-09)
(21,9.441262506834e-11) (22,7.090946380126e-12) (23,4.205212669704e-13)
(24,1.752171945710e-14) (25,3.502753248000e-16)
};
...
(0,2.980232238770e-08) (1,7.450580596924e-07) (2,8.940696716309e-06)
(3,6.854534149170e-05) (4,3.770993232727e-04) (5,1.583814620972e-03)
(6,5.279382169247e-03) (7,1.437395811081e-02) (8,3.233140945435e-02)
(9,6.087416887283e-02) (10,9.739867001772e-02) (11,1.329527327418e-01)
(12,1.549810171127e-01) (13,1.549810171127e-01) (14,1.329527327418e-01)
(15,9.739867001772e-02) (16,6.087416887283e-02) (17,3.233140945435e-02)
(18,1.437395811081e-02) (19,5.279382169247e-03) (20,1.583814620972e-03)
(21,3.770993232727e-04) (22,6.854534149170e-05) (23,8.940696716309e-06)
(24,7.450580596924e-07) (25,2.980232238770e-08)
};

% --- p = 0,8 (gelb) rechts --- nur bis k=36
\addplot+[
  fill=yellow!85!orange,
  draw=yellow!55!black,
  line width=0.4pt,
...
(0,3.502753248000e-16) (1,1.752171945710e-14) (2,4.205212669704e-13)
(3,7.090946380126e-12) (4,9.441262506834e-11) (5,1.043383264199e-09)
(6,9.941744420951e-09) (7,8.188923173108e-08) (8,5.892024684638e-07)
(9,3.682515427899e-06) (10,2.016856036527e-05) (11,9.680908095241e-05)
(12,4.065581400002e-04) (13,1.491043213400e-03) (14,4.771338282880e-03)
(15,1.323281580224e-02) (16,3.182279512562e-02) (17,6.555951494659e-02)
(18,1.144296494291e-01) (19,1.666128371482e-01) (20,1.960151025272e-01)
(21,1.827829863714e-01) (22,1.353132491640e-01) (23,7.083549724302e-02)
(24,2.361183241434e-02) (25,3.777893186295e-03)
};

% ----- Beschriftungen -----
\node[anchor=west] at (rel axis cs:0.4,1.05) {\textcolor{blue}{$\mathrm{B}(25;\,p;\,k)$}};

\node[anchor=west, text=red!80!black, font=\bfseries]  at (axis cs:3.8,0.215) {p = 0,2};
\node[anchor=west, text=cyan!70!blue, font=\bfseries] at (axis cs:11.3,0.215) {p = 0,5};
\node[anchor=west, text=yellow!60!orange, font=\bfseries] at (axis cs:18.8,0.215) {p = 0,8};

\node[anchor=west] at (axis cs:15.0,0.165) {n = 25};

\node[anchor=west] at (axis cs:30.0,0.225) {n konstant};
\node[anchor=west] at (axis cs:30.0,0.175) {p variabel};
...
\begin{axis}[
  ...
  bar width=6pt,
  enlarge x limits=0,  
  % keine automatische Randverschiebung
  xlabel={},           % x-Beschriftung aus
  ylabel={},           % y-Beschriftung aus
  xmin=0, xmax=26.5,
  ymin=0, ymax=0.26,
...
% Beschriftungen wie im Bild
\node[anchor=west] at (rel axis cs:0.25,1.05) {\textcolor{blue}{$\mathrm{B}(n;\,0{,}5;\,k)$}};
\node[anchor=west] at (rel axis cs:1.01,0.08) {$k$};
...
% --- gestrichelte Trennlinie (wie im Bild, zwischen 12 und 13) ---
\draw[purple!60, very thick, dashed]
  (axis cs:12.5,0) -- (axis cs:12.5,0.26);
% --- Beschriftungen im Stil deines Schemas ---
\node[anchor=west] at (rel axis cs:0.25,1.1) {\textcolor{blue}{$\mathrm{B}(25;\,p;\,k)$}};
\node[anchor=west, text=cyan!70!blue, font=\bfseries] at (axis cs:2.5,0.215) {p = 0,2};
\node[anchor=west, text=red!80!black, font=\bfseries] at (axis cs:16.8,0.215) {p = 0,8};
\node[anchor=center] at (axis cs:12.5,0.17) {n = 25};
...
\end{defi}
\begin{defi}{Dichtefunktion}{}\index{Zufallsgröße!Stetige!Dichtefunktion}\label{EigenStetigeZG}
...
\begin{defi}{Erwartungswert, Varianz und Standardabweichung}{}\index{Zufallsgröße!Stetige!Erwartungswert}\index{Zufallsgröße!Stetige!Varianz}\index{Zufallsgröße!Stetige!Standardabweichung}
  ...
  \end{description}  
\end{defi}
    \subsection{Die Gauß'sche Glockenkurve}\index{Zufallsgröße!Stetige!Gauß'sche Glockenfunktion}
    ...
    \begin{satz}{Eigenschaften der Scharfunktion \(\varphi_{\mu, \sigma}\)}{}\label{EigenschaftGauss}
        ...
        \begin{enumerate}
            ...
            \item \label{NormExtrem}\(G_{\varphi_{\mu, \sigma}}\) hat als Extrempunkt nur den Hochpunkt \(H(\mu |\varphi_{\mu, \sigma}(\mu))\) mit \(\varphi_{\mu, \sigma}(\mu)) = \dfrac{1}{\sigma \sqrt{2\pi}}\)
            \item \label{WendeNorm}\(G_{\varphi_{\mu, \sigma}}\) hat die Wendepunkte \(W_{1,2} (\mu \pm \sigma|\varphi_{\mu, \sigma}(\mu \pm \sigma)))\) mit \( \varphi_{\mu, \sigma}(\mu \pm \sigma)) = \dfrac{1}{\sigma\sqrt{2\pi}}\cdot e^{-\frac{1}{2}}\)
...
\begin{defi}{Die Normalverteilung}{}\index{Zufallsgröße!Stetige!Normalverteilung}\label{NormZG}
    Eine Zufallsgröße \(X\) heißt \textcolor{red}{\textbf{normalverteilt}} mit dem Parameter \(\textbf{\mu}\) (Erwartungswert) und \(\textbf{\sigma}\) (Standardabweichung), wenn ihre Dichtefunktion eine Gauß'sche Glockenfunktion \(\varphi_{\mu, \sigma}\) ist. \\
    Die Wahrscheinlichkeit dafür, dass \(X\) Werte aus dem Intervall \([a;b]\) mit \(a<b\) und \(a,b \in \mathds{R}\) annimmt, ist \(P(a\leq X\leq b) = \integral[limits-mode=limits,limits={a, b}]{\varphi_{\mu, \sigma}} =\Phi_{\mu, \sigma} (b) - \Phi_{\mu, \sigma} (a)\).
\end{defi}
\begin{b8d}{Bezeichnungen}{}
Ist die Zufallsgröße \(X\) normalverteilt so spricht man von  \(N_{\mu, \sigma}\)-verteilt. Für die Werte \(\mu =0\) und \(\sigma = 1\) spricht man von einer Standardnormalverteilung.
\end{b8d}
Da die Zufallsgröße \(X\) eine \(N_{\mu, \sigma}\)-verteilte ist und damit eine stetige Zufallsgröße, gelten die entsprechenden Eigenschaften aus \ref{EigenStetigeZG} und  \ref{EigenschaftGauss}.
\begin{bem}{Wiederholung}{}
    Da \(\varphi_{\mu, \sigma}\) eine Dichtefunktion der Zufallsgröße \(X\) ist gilt:
    \begin{enumerate}
        \item \(P(X=x)=0\) die Wahrscheinlichkeit eines einzelnen Wertes ist 0
        \item \(P(a\leq X\leq b) = P(a\leq X<b) = P(a<X\leq b) = P(a<X<b)\)
    \end{enumerate}
\end{bem}
\begin{b8d}{Berechnung der Dichte der Normalverteilung (Normal PD)}{}\index{Normalverteilung!Taschenrechner!Dichte}
\begin{center}
\begin{tabular}{p{0.94\linewidth}}
\hline
\textbf{Route zur Normal-PD-Funktion (Dichte)}\\[4pt]
1) \taste{MODE/SETUP} \;\(\rightarrow\)\; Auswahlmenü\\
2) \taste{4} \;\(\rightarrow\)\; \textbf{DIST} (Verteilung)\\
3) \taste{1} \;\(\rightarrow\)\; \textbf{Normal PD}\\
4) \taste{2} \;\(\rightarrow\)\; \textbf{Variablen eingeben}\\[4pt]
\textbf{Eingabereihenfolge:}\\
Zuerst \(\;x\) (Stelle, an der die Dichte berechnet wird) \(\rightarrow\)
dann \(\;\sigma\) (Standardabweichung, \(\sigma>0\)) \(\rightarrow\)
dann \(\;\mu\) (Erwartungswert).\\
\hline
\end{tabular}
\end{center}

\noindent
\textbf{Was rechnet Normal PD hier?} In diesem Modus liefert der Rechner die
\textcolor{red}{\textbf{\emph{Wahrscheinlichkeitsdichte}}} der Normalverteilung an der Stelle \(x\):
\[
\boxed{\text{Normal PD}(x;\mu,\sigma)=\varphi_{\mu, \sigma}(x)}
\]
\textbf{Wichtig (typischer Denkfehler):} Das Ergebnis ist \textcolor{red}{\textbf{\emph{keine Wahrscheinlichkeit}}}.
Wahrscheinlichkeiten bekommst du erst über \textbf{Normal CD} (Flächen unter der Kurve).
\end{b8d}

\begin{b8d}{Berechnung der kumulativen Normalverteilung (Normal CD)}{}\index{Normalverteilung!Taschenrechner!kumulativ}
\begin{center}
\begin{tabular}{p{0.94\linewidth}}
\hline
\textbf{Route zur Normal-CD-Funktion (kumulativ)}\\[4pt]
1) \taste{MODE/SETUP} \;\(\rightarrow\)\; Auswahlmenü\\
2) \taste{4} \;\(\rightarrow\)\; \textbf{DIST} (Verteilung)\\
3) \taste{2} \;\(\rightarrow\)\; \textbf{Normal CD}\\
4) \taste{2} \;\(\rightarrow\)\; \textbf{Variablen eingeben}\\[4pt]
\textbf{Eingabereihenfolge:}\\
Zuerst \(\;\text{Lower}\) (untere Grenze) \(\rightarrow\)
dann \(\;\text{Upper}\) (obere Grenze) \(\rightarrow\)
dann \(\;\sigma\) (Standardabweichung, \(\sigma>0\)) \(\rightarrow\)
dann \(\;\mu\) (Erwartungswert).\\
\hline
\end{tabular}
...
\noindent
\textbf{Was rechnet Normal CD hier?} Der Rechner liefert \textcolor{red}{\textbf{\emph{die Wahrscheinlichkeit}}}, dass
eine normalverteilte Zufallsvariable \(X\sim \mathcal{N}(\mu,\sigma)\) im Intervall liegt:
\[
\boxed{\text{Normal CD}(\text{Lower},\text{Upper};\mu,\sigma)=P(\text{Lower}\le X\le \text{Upper}) = \Phi_{\mu, \sigma} (\text{Upper}) - \Phi_{\mu, \sigma} (\text{Lower})}
\]

\medskip
\noindent
\textbf{Standardfälle (die du ständig brauchst):}
\begin{itemize}
\item \(\;P(X\le x)\): Setze \(\text{Upper}=x\) und \(\text{Lower}\) ``sehr klein''.\\
\hspace*{1.5em}\(\rightarrow\) Praktisch am TR: \(\text{Lower}=-1\cdot 10^{99}\) (oder ähnlich extrem negativ).
\item \(\;P(X\ge x)\): Setze \(\text{Lower}=x\) und \(\text{Upper}\) ``sehr groß''.\\
\hspace*{1.5em}\(\rightarrow\) Praktisch am TR: \(\text{Upper}=1\cdot 10^{99}\) (oder ähnlich extrem positiv).
\item \(\;P(a\le X\le b)\): Setze \(\text{Lower}=a\), \(\text{Upper}=b\).

\end{itemize}

\noindent
\textbf{Damit es funktioniert:} Achte auf \(\mu\) und \(\sigma\).
Der häufigste Fehler ist, \(\sigma\) (Standardabweichung) mit \(\sigma^2\) (Varianz) zu verwechseln.
Wenn deine Ergebnisse „komisch“ aussehen: genau da zuerst hinschauen.
\end{b8d}
\subsubsection{Erkennungsmerkmale eine Normalverteilung}
%%%%%
\textbf{Kernidee:} Normalverteilung passt oft bei \textbf{stetigen Messgrößen}, wenn \textbf{viele kleine, unabhängige Einflüsse} zusammenwirken und die Werte \textbf{ungefähr symmetrisch} um einen Mittelwert liegen.
...
\textbf{Schnell-Check:}
\begin{itemize}
\item \textbf{Zählt man?} (nur ganze Zahlen) \(\rightarrow\) \textbf{nicht normal} (evtl. Binomial/Poisson; manchmal Normalapproximation).
\item \textbf{Misst man stetig?} (Kommawerte möglich) \(\rightarrow\) Normal \textbf{kann} passen.
\item \textbf{Symmetrisch + „viele kleine Ursachen“?} \(\rightarrow\) Normal ist \textbf{plausibel}. Bei starker Schiefe eher nicht.
\end{itemize}
\subsubsection{Entscheidungsbaum}
\index{Zufallsgröße!Stetige!Entscheidungsbaum}
\begin{adjustbox}{max totalsize={\textwidth}{0.85\textheight}, left}
\begin{tikzpicture}[
  node distance=17mm and 17mm,
  box/.style={
    draw, rounded corners=3pt, align=center,
    inner sep=4pt, text width=0.75\linewidth
  },
  decision/.style={
    draw, diamond, aspect=2.0, align=center,
    inner sep=2pt, text width=0.32\linewidth
  },
  arrow/.style={-Latex, thick},
  every node/.style={font=\LARGE} % optional: nur leicht kleiner
]
\node[box] (start) {\textbf{Start:} Man soll ein Modell \\ für eine Zufallsgröße \(X\) wählen.};

\node[decision, below=of start] (count) {\textbf{Zählt man?}\\
(nur ganze Zahlen: Treffer,\\ Anzahl, Stückzahl)};

\node[box, below right=of count, xshift=-10mm] (notnormal1) {\textbf{Dann: eher nicht normal.}\\
Typisch: Binomial.\\
\textbf{Achtung:} Normalapproximation\\ manchmal möglich (bei großem \(n\)).};

\node[decision, below left=of count, xshift=10mm] (continuous) {\textbf{Stetig messbar?}\\
(Kommawerte möglich, Messgröße)};

\node[box, below right=of continuous, xshift=-10mm] (notnormal2) {\textbf{Dann: \\ normal unpassend.}\\
Diskrete Modelle prüfen.};

\node[decision, below left=of continuous, xshift=10mm] (mechanism) {\textbf{Viele kleine unabhängige Einflüsse?}\\
(Messfehler, Schwankungen, Summe vieler Mini-Effekte)};

\node[decision, below=of mechanism] (shape) {\textbf{Ungefähr symmetrisch\\ um \(\mu\)?}\\
(links/rechts ähnlich, ein Gipfel)};

\node[box, below right= of shape, xshift=-10mm] (skew) {\textbf{Eher nicht normal.}\\
Häufig bei Wartezeiten,\\ Einkommen, Lebensdauern (rechtsschief).};

\node[box, below left=of shape, xshift=-10mm] (normalok) {\textbf{Normalverteilung\\ ist plausibel.}\\
Checke zusätzlich: Grenzen/Ausreißer.};

\draw[arrow] (start) -- (count);
\draw[arrow] (count) -- node[midway, left]{\small Ja} (notnormal1);
\draw[arrow] (count) -- node[midway, right]{\small Nein} (continuous);

\draw[arrow] (continuous) -- node[midway, left]{\small Nein} (notnormal2);
\draw[arrow] (continuous) -- node[midway, right]{\small Ja} (mechanism);

\draw[arrow] (mechanism) -- (shape);
\draw[arrow] (shape) -- node[midway, left]{\small Nein} (skew);
\draw[arrow] (shape) -- node[midway, right]{\small Ja} (normalok);

\end{tikzpicture}
\end{adjustbox}

\vspace{0.4em}
\textbf{Typische Stolperstelle:} „Normal“ heißt nicht „immer richtig“. Es ist ein \textbf{Modell}.
Wenn Daten stark schief sind, viele Ausreißer haben oder nahe an einer harten Grenze liegen (z.\,B. nahe 0),
ist die Normalverteilung nicht anwendbar.

\vspace{0.8em}
\textbf{Glocke vs.\ schiefe Glocke}

\begin{center}
\begin{tikzpicture}[x=1cm,y=1cm]
  % Left plot: bell curve
  \begin{scope}
    \draw[thick] (0,0) -- (6,0);
    \draw[thick] (0,0) -- (0,3.2);
    \node[below] at (3,0) {\small \(x\)};
    \node[left] at (0,1.8) {\small \(f(x)\)};
    \node[above] at (3,3.0) {\small \textbf{„Glocke“ (symmetrisch)}};

    % bell curve (approx Gaussian)
    \draw[thick, smooth] plot coordinates {
      (0.3,0.2) (0.8,0.45) (1.3,0.85) (1.8,1.45)
      (2.3,2.25) (2.8,2.85) (3.0,3.0) (3.2,2.85)
      (3.7,2.25) (4.2,1.45) (4.7,0.85) (5.2,0.45) (5.7,0.2)
    };
    \draw[dashed] (3,0) -- (3,3.0);
    \node[below] at (3,-0.5) {\small \(\mu\)};
  \end{scope}

  % Right plot: right-skewed curve
  \begin{scope}[xshift=8.2cm]
    \draw[thick] (0,0) -- (6,0);
    \draw[thick] (0,0) -- (0,3.2);
    \node[below] at (3,0) {\small \(x\)};
    \node[left] at (0,1.8) {\small \(f(x)\)};
    \node[above] at (3,3.0) {\small \textbf{„Schief“ (rechtsschief)}};

    % skewed curve: sharp rise then long tail
    \draw[thick, smooth] plot coordinates {
      (0.2,0.0) (0.5,0.25) (0.8,0.85) (1.1,1.9)
      (1.3,2.6) (1.5,2.9) (1.8,2.5) (2.2,1.9)
      (2.8,1.25) (3.6,0.8) (4.5,0.5) (5.4,0.32) (5.8,0.25)
    };
  \end{scope}
\end{tikzpicture}
\end{center}
...
\textbf{Beispiele (mit kurzer Begründung)}

\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*.}]
\item \textbf{Körpergröße in einer Jahrgangsstufe (grobe Näherung):} 
stetig, viele Einflüsse (Genetik, Ernährung, Zufall), oft recht symmetrisch \(\Rightarrow\) Normalverteilung \textit{plausibel}.
\item \textbf{Messfehler bei einem Experiment:} \\
„wahrer Wert + viele kleine Störungen“ \(\Rightarrow\) Normalverteilung \textit{sehr typisch}.
\item \textbf{Anzahl richtiger Antworten in einem Multiple-Choice-Test:} \\
\textbf{Zählgröße} \(\Rightarrow\) nicht normal (binomialartig). \\
\textit{Aber:} bei großem \(n\) manchmal Normalapproximation.
\item \textbf{Wartezeit bis der Bus kommt:} \\
oft \textbf{rechtsschief} (klein geht, aber nach oben langer Schwanz) \(\Rightarrow\) Normalverteilung meist unpassend.
\item \textbf{Einkommen:} \\
stark rechtsschief, viele Ausreißer \(\Rightarrow\) Normalverteilung \textbf{unrealistisch}.
\end{enumerate}
\subsection{\(\sigma\)-Regeln}
Eine normalverteilte Zufallsgröße \(X\) mit der Dichtefunktion \(\varphi_{\mu, \sigma}\) hat nach Definition \ref{NormZG} den Erwartungswert \(\mu\) und die Standardabweichung \(\sigma\). Nach dem Satz \ref{EigenschaftGauss} und der Eigenschaft \ref{NormExtrem} hat \(\varphi_{\mu, \sigma}\) das Maximum bei \(\mu\) mit dem Funktionswert \(\varphi_{\mu, \sigma}(\mu) = \dfrac{1}{\sigma\sqrt{2\pi}}\). Der Wendepunkt liegt nach dem Satz \ref{EigenschaftGauss} und der Eigenschaft \ref{WendeNorm} bei \(x= \mu \pm \sigma\). Die Wahrscheinlichkeit dafür, dass Werte in diesem, zu \(\mu \) symmetrischen, Intervall liegen ist 
\[\integral[limits-mode=limits,limits={\mu - \sigma , \mu + \sigma}]{\varphi_{\mu, \sigma}} =\Phi_{\mu, \sigma} (\mu + \sigma) - \Phi_{\mu, \sigma} (\mu - \sigma) = 0,683\ldots\] unabhängig von der Wahl der Parameter \(\mu\) und \(\sigma\). Der Nachweis dafür ergibt sich aus Überlegungen am Graphen der Dichtefunktion.\\
Wird diese Überlegung verallgemeinert ergibt sich für das Integral \[\integral[limits-mode=limits,limits={\mu - k\cdot\sigma , \mu + k\cdot\sigma}]{\varphi_{\mu, \sigma}}\hspace{0.2cm} \text{mit} \hspace{0.2cm} k\in \mathds{R}^+\] nur eine Abhängigkeit vom Parameter \(k\). 

\begin{merke}{Die Sigma Intervalle}{}
\index{Zufallsgröße!Stetige!Sigma-Regeln}Durch die Analyse der normalverteilten Zufallsgrößen lassen sich die folgenden Intervalle bestimmen. 
% 1) TABELLEN (oben)
...
\begin{tabular}{|>{\raggedright\arraybackslash}p{0.52\linewidth}|>{\raggedright\arraybackslash}p{0.22\linewidth}|}
\hline
\rowcolor{headbg}\textbf{Intervall \(I\)} & \textbf{\(P(X\in I)\)}\\ \hline
\([\mu-\sigma;\,\mu+\sigma]\)   & \(\approx 0{,}683\)\\ \hline
\([\mu-2\sigma;\,\mu+2\sigma]\) & \(\approx 0{,}954\)\\ \hline
\([\mu-3\sigma;\,\mu+3\sigma]\) & \(\approx 0{,}997\)\\ \hline
\end{tabular}
...
\hline
\rowcolor{headbg}\textbf{Intervall \(I\)} & \textbf{\(P(X\in I)\)}\\ \hline
\([\mu-1{,}64\sigma;\,\mu+1{,}64\sigma]\) & \(\approx 0{,}900\)\\ \hline
\([\mu-1{,}96\sigma;\,\mu+1{,}96\sigma]\) & \(\approx 0{,}950\)\\ \hline
\([\mu-2{,}58\sigma;\,\mu+2{,}58\sigma]\) & \(\approx 0{,}990\)\\ \hline
\end{tabular}
\end{center}
...
\begin{tikzpicture}[font=\small]
  % Achsen
  \draw[-{Latex[length=3mm]}, thick] (0,0) -- (11,0) node[below right] {\(x\)};
  \draw[-{Latex[length=3mm]}, thick] (0,0) -- (0,4.5) node[left] {\(y\)};

  % Parameter: μ=5, σ=1 (nur zur Skizze)
  \def\mu{5}
  \def\s{1.5}

  % Fläche + Kurve
  \fill[curvefill, opacity=0.55]
    (0.6,0) --
    plot[smooth, samples=160, domain=0.6:9.4]
      (\x, {4.0*exp(-0.5*((\x-\mu)/\s)^2)}) --
    (9.4,0) -- cycle;

  \draw[thick]
    plot[smooth, samples=160, domain=0.2:10.4]
      (\x, {4.0*exp(-0.5*((\x-\mu)/\s)^2)});

  % gestrichelte Linie bei μ
  \draw[gray, dashed, thick] (\mu,0) -- (\mu,4.2);
  \node[below] at (\mu,0) {\(\mu\)};

  % Hilfslinien bei μ±kσ
  \foreach \k/\col in {1/sig1,2/sig2,3/sig3}{
    \draw[\col, dashed, thick] ({\mu-\k*\s},0) -- ({\mu-\k*\s},{4.0*exp(-0.5*(\k)^2)});
    \draw[\col, dashed, thick] ({\mu+\k*\s},0) -- ({\mu+\k*\s},{4.0*exp(-0.5*(\k)^2)});
  }

  % obere Klammern: 1σ links/rechts
  \draw[sig1, thick, decorate, decoration={brace, amplitude=5pt}]
    ({\mu-\s},4.05) -- (\mu,4.05) node[midway, yshift=14pt] {\(1\sigma\)};
  \draw[sig1, thick, decorate, decoration={brace, amplitude=5pt}]
    (\mu,4.05) -- ({\mu+\s},4.05) node[midway, yshift=14pt] {\(1\sigma\)};

  % 2σ und 3σ (eine Klammer über dem Bauch)
  \draw[sig2, thick, decorate, decoration={brace, amplitude=5pt}]
    ({\mu-2*\s},3.25) -- ({\mu+2*\s},3.25) node[midway, yshift=14pt] {\(2\sigma\)};
  \draw[sig3, thick, decorate, decoration={brace, amplitude=5pt}]
    ({\mu-3*\s},2.45) -- ({\mu+3*\s},2.45) node[midway, yshift=14pt] {\(3\sigma\)};

  % Prozentangaben innen
  \node[sig2] at ({\mu-1.5*\s},0.5) {\(13{,}55\%\)};
  \node[sig1] at ({\mu-0.5*\s},0.75) {\(34{,}15\%\)};
  \node[sig1] at ({\mu+0.5*\s},0.75) {\(34{,}15\%\)};
  \node[sig2] at ({\mu+1.5*\s},0.5) {\(13{,}55\%\)};
  \node[sig3] at ({\mu-2.65*\s},0.45) {\small \(2{,}15\%\)};
  \node[sig3] at ({\mu+2.65*\s},0.45) {\(2{,}15\%\)};

  % Klammern unten: 68.3 / 95.4 / 99.7
  \draw[sig1, very thick, decorate, decoration={brace, amplitude=6pt, mirror}]
    ({\mu-\s},-0.10) -- ({\mu+\s},-0.10) node[midway, yshift=-16pt] {\(68{,}3\%\)};
  \draw[sig2, very thick, decorate, decoration={brace, amplitude=6pt, mirror}]
    ({\mu-2*\s},-0.8) -- ({\mu+2*\s},-0.8) node[midway, yshift=-16pt] {\(95{,}4\%\)};
  \draw[sig3, very thick, decorate, decoration={brace, amplitude=6pt, mirror}]
    ({\mu-3*\s},-1.5) -- ({\mu+3*\s},-1.5) node[midway, yshift=-16pt] {\(99{,}7\%\)};

  % Label rechts
  \node[right] at (9.6,0.35) {\(G_{\mu;\sigma}\)};
\end{tikzpicture}
\end{center}
\end{merke}
\begin{b8d}{Weitere Wahrscheinlichkeiten}{}
Aufgrund der Symmetrie der Glockenkurve zum Erwartungswert lassen sich mithilfe der Sigma-Regeln weitere Wahrscheinlichkeiten bestimmen.
\begin{enumerate}
    \item \(P(X\geq \mu + \sigma)\) ergibt sich aus den Überlegungen, dass \(P(X\geq \mu) \approx 0{,}5 \) und \\ \(P(\mu \leq X \leq \mu + \sigma) \approx \dfrac{1}{2}\cdot 0{,}683 = 0{,}3415\) wie folgt:
    \[P(X\geq \mu + \sigma) \approx 0{,}5 - 0{,}3415 = 0{,}1585\]
    \item \(P(\mu -2\sigma \leq X \leq \mu -\sigma) \approx \dfrac{1}{2} \cdot \left( 0{,}954 - 0{,}683 \right) = 0{,}1355  \)
\end{enumerate}
\end{b8d}
\begin{rechnung}{Rechnungen mit den Sigma-Regeln}{}
    Bestimmen Sie mithilfe der Sigma-Regeln zu einer \(N_{200;75}\)-verteilten Zufallsgröße \(X\) ein Intervall \(I\) so, dass für die Wahrscheinlichkeit \(P(X\in I)\) gilt:
    \begin{multicols}{2}
    \begin{description}
        \item[a)] \(P(X\in I) \approx 0{,}954\)
        \item[b)] \(P(X\in I)\approx 0{,}050\) 
    \end{description}
    \end{multicols}
    Lösungen:
    \begin{description}
        \item[a)] Aus der Angabe entnimmt man die Werte \(\mu = 200\) und \(\sigma = 75\). Damit kann man festhalten \(P(\mu-2\sigma \leq X \leq \mu+2\sigma) = P(200 - 2\cdot 75 \leq X\leq 200 + 2\cdot 75)\approx 0{,}954\) damit ist \[I=\left[50;350\right]\] 
        \item[b)] \(P(\mu-1{,}64\sigma \leq X\leq \mu+1{,}64\sigma) \approx 0{,}900\) damit folgt für \\ \(P(\mu-1{,}64\sigma \leq X \leq \mu) \approx \frac{1}{2} \cdot 0{,}900 = 0{,}450\) damit ist \(P(\mu-1{,}64\sigma \leq X) \approx 0{,}050\) also ist \[I_1=\left[-\infty; \mu-1{,}64\sigma\right] = \left[-\infty;200- 1{,}64 \cdot 75\right] = \left[-\infty; 77\right]\] bzw. \[I_2 = \left[\mu+1{,}64\sigma; \infty\right] = \left[200 + 1{,}64 \cdot 75; \infty\right] = \left[323; \infty\right]\]
