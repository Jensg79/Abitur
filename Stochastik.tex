...
\end{satz}
\begin{b8d}{Berechnung der kumulativen Binomialverteilung}{}\index{Binomialverteilung!Berechnung mit Taschenrechner!\(P^n_p(X\leq k)\)}
\begin{center}
...
\end{b8d}
\begin{b8d}{Berechnung der Wahrscheinlichkeit in den Taschenrechner}{}\index{Binomialverteilung!Berechnung mit Taschenrechner!\(P^n_p(X=k)\)}
\begin{center}
\begin{tabular}{p{0.94\linewidth}}
\hline
