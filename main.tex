...
\begin{center}
    \begin{tikzpicture}
        ...
        ylabel=$y$]
            ...
            \draw[dashed,-latex] (1.24,-1.41)  -- (1.24,0) node(xline)[above] {$x_0$};
            \draw (1.24,-1.41)   node[left] {$A(x_0|f(x_0))$};
            \draw (1.2390888331407657,-1.4073470487766349)-- ++(-2.5pt,-2.5pt) -- ++(5pt,5pt) ++(-5pt,-0.5pt) -- ++(5pt,-5pt);
        \end{axis}
    \end{tikzpicture}     
\end{center}
\end{bsp}
