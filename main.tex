...
\end{equation*}
\end{itemize}
\item Wertemenge: $WP= [-\dfrac{27}{16} \hspace{0.1cm}|\hspace{0.1cm} \infty[$
...
Durch die additive Konstante $c$ wird die Menge dr Stammfunktionen beschrieben. Sollen also {\bfseries\textcolor{red}{alle}} Stammfunktionen angegeben werden, muss die Konstante $c$ stehts mit angegeben werden. Wird nur eine Stammfunktion verlangt, reicht es, dass nur ein Wert für $c$ eingesetzt wird.
\end{b8d}
\begin{bsp}{Beispiele der Stammfunktion}{}
\begin{itemize}
    \item $f(x) = x^4 \hspace{0.2cm} \longrightarrow \hspace{0.2cm} F(x) = \dfrac{1}{5} x^5 + c $
    \item $f(x) = -\dfrac{3}{4} x^7 \hspace{0.2cm} \longrightarrow \hspace{0.2cm} F(x)= -\dfrac{3}{4} \cdot \dfrac{1}{8} x^8 + c$
\end{itemize}
\end{bsp}
\end{section}
