...
\end{merke*}
\label{hmethode}
\begin{merke*}{Die h-Methode zur Berechnung der Steigung }{hmethode}\index{Ableitung!h-Methode}
...
\end{merke*}
\subsection{Lokale Änderungsrate}\index{Änderungsrate!lokale}
...
Siehe hierfür auch die Erläuterungen der h-Methode \ref{hmethode} oder die einzelnen Ableitungsregeln.
